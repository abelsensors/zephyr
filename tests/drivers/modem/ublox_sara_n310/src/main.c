...
{
	//these function dont actually get called. The probably get copied by the init function.
	api_funcs_mock->init = modem_net_iface_init_mock;

	offload_socket_fd_op_vtable_mock->bind = offload_bind_mock;
	offload_socket_fd_op_vtable_mock->connect = offload_connect_mock;
	offload_socket_fd_op_vtable_mock->sendto = offload_sendto_mock;
}
